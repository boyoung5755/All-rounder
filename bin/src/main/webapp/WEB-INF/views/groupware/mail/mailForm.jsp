...
<!--    <script src="/resources/assets/vendor/libs/quill/quill.js"></script> -->
   ...
   <link rel="stylesheet" href="/resources/js/app/mail/mail.css">
                        ...
                        <ul class="email-filter-folders list-unstyled pb-1">
                          <li class="active d-flex justify-content-between" data-target="inbox">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              ...
                              <span class="align-middle ms-2" id="receptionMailBox">받은메일함</span>
                            </a>
                            <div class="badge bg-label-primary rounded-pill" id="receptionMailBoxCount">21</div>
                          </li>
                          <li class="d-flex" data-target="sent">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-send"></i>
                              <span class="align-middle ms-2" id="sentMailBox">보낸메일함</span>
                            </a>
                          </li>
                          <li class="d-flex justify-content-between" data-target="draft">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-edit"></i>
                              <span class="align-middle ms-2">임시저장함</span>
                            </a>
                          ...
                          <li class="d-flex" data-target="starred">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              ...
                              <span class="align-middle ms-2" id="importantMailBox">중요메일함</span>
                            </a>
                          </li>
                          <li class="d-flex align-items-center" data-target="trash">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-trash-alt"></i>
                              <span class="align-middle ms-2" id="deletedMailBox">휴지통</span>
                            </a>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div class="card shadow-none border-0">
                        <div class="card-body emails-list-header p-3 py-lg-3 py-2">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div id="pagingHere" class="email-pagination d-sm-flex d-none align-items-center flex-wrap justify-content-between justify-sm-content-end">
...
<!--                               <i class="email-next bx bx-chevron-right scaleX-n1-rtl cursor-pointer fs-4"></i> -->
     ...
     <!---------------------------------------- 현재 메일 내용 -------------------------------->
                        <div class="card email-card-last mx-sm-4 mx-3 mt-4 border">
                          <div
                            ...
                            <div class="d-flex align-items-center mb-sm-0 mb-3">
                              <img
                                src="/resources/assets/img/avatars/18.png"
                                alt="user-avatar"
                                class="flex-shrink-0 rounded-circle me-2"
                                height="38"
                                width="38" />
                              <div class="flex-grow-1 ms-1">
                                <h6 class="m-0" id="mailViewName"></h6>
                                <small class="text-muted" id="mailViewEmail"></small>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                        ...
                        <div class="email-reply card mt-4 mx-sm-4 mx-3 border">
                          <h6 class="card-header border-0">답장 기능 할까말까~~</h6>
...
<!--                                 </span> -->
                          ...
                          <div
                            ...
                            <div class="d-flex align-items-center">
                              <div class="btn-group">
                                <input type="button" value="Send" id="sendBtn" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"/>
                                <button
                                  type="button"
...
<!--                               <label class="attachments" for="attachments"><img width="10px" height="10px" src='/resources/images/iconFileAttach..png' alt="Icon"></label> -->
                              <input type="file" name="files" class="attachments" id="attachments" multiple  />
                            </div>
                            <div class="d-flex align-items-center">
                              <div class="dropdown">
                                <button
			...
			<form method="get" id = "searchForm" class = "border" >
				<input type="text" id="page" name="page" readonly="readonly" placeholder="page"/>
			</form>
