        ...
        <form action="/account/insert"  enctype="multipart/form-data" id="formAccountSettings" method="POST" 
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6 fv-plugins-icon-container">
              ...
              <input class="form-control" type="text" id="empName" name="empName" value='<c:out value="${emp.empName}"/>' autofocus="autofocus">
            </div>
            <div class="mb-3 col-md-6 fv-plugins-icon-container">
              <label for="lastName" class="form-label">비밀번호</label>
              <input class="form-control" type="text" name="empPw" id="empPw" value="" /> 
            </div>
            <div class="mb-3 col-md-6 fv-plugins-icon-container">
              <label for="lastName" class="form-label">주민번호</label>
              <div class="row">
                <div class="mb-6 col-md-6 ">
                  <input class="form-control" type="text" name="empSsn1" id="empSsn1" value='<c:out value="${fn:split(emp.empSsn,'-')[0]}"/>' readonly>
                </div>
                <div class="mb-6 col-md-1" style="text-align: center;">
                  <H4>-</H4>
                </div>
                <div class="mb-6 col-md-5 ">
                  <input class="form-control" type="password" name="empSsn2" id="empSsn2" value='<c:out value="${fn:split(emp.empSsn,'-')[1]}"/>' readonly>
                </div>
              </div>
            </div>
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="date" id="empHiredate" name="empHiredate" value='<c:out value="${formattedDate}"/>' >
            </div>
            <div class="mb-3 col-md-6">
              <label for="email" class="form-label">E-mail</label>
              <input class="form-control" type="email" id="empMail" name="empMail" value='<c:out value="${emp.empName}"/>'>
            </div>
            <div class="mb-3 col-md-6 ">
            ...
            <div class="mb-3 col-md-6 ">
              ...
              <select id="empPosition" class="form-select" tabindex="0" name="empPosition">
                <option selected value="">팀원</option>
            ...
            <div class="mb-3 col-md-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="empTelno" name="empTelno" class="form-control" value='<c:out value="${fn:substringAfter(emp.empTelno,'010-')}"/>'>
              </div>
            </div>
            <div class="mb-3 col-md-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="empExtension" name="empExtension" class="form-control" value='<c:out value="${fn:substringAfter(emp.empExtension,'070-')}"/>'>
              </div>
            </div>
            <div class="mb-3 col-md-6">
              ...
              <div class="row">
                <div class="mb-6 col-md-9">
                  <input class="form-control" type="text" name="empZip" id="empZip" maxlength="5" value='<c:out value="${emp.empZip}"/>'>
                </div>
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="empAdres" name="empAdres" value='<c:out value="${emp.empAdres}"/>'>
            </div>
            <div class="mb-3 col-md-6">
              <label for="zipCode" class="form-label">상세주소</label>
              <input type="text" class="form-control" id="empAdresDetail" name="empAdresDetail" value='<c:out value="${emp.empAdresDetail}"/>'>
            </div>
            <div class="mb-3 col-md-6">
