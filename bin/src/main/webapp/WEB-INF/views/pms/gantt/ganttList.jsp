                        ...
                        <div  class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                          ...
                          <div  class="offcanvas-body my-auto mx-0 flex-grow-0">
                            ...
                            <font style="vertical-align: inherit;">
                              	...
                              	<h3>일감등록일:<span id="jobRdate"></span></h3> 
								<h3>담당자: <span id="jobmem"></span></h3>
								<h3>시작일: <span id="jobBdate"></span></h3>
								<h3>종료일: <span id="jobEdate"></span></h3>
								<h3>진행도: <span id="jobProgrses"></span>%</h3> 
								<div class="progress"> 
<!--                       <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" style="width: $('#jobProgrses span').text() %" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div> -->
                            ...
                            <button type="button" class="btn btn-primary mb-2 d-grid w-100"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">수정하기</font></font></button>
...
<!-- <div id="myModal" > -->
<!-- 	<div id="modContent"> -->
<!-- 		<div id="modal-hheader"> -->
<!-- 			<button onclick="fCloseModal()">X</button> -->
<!-- 		</div> -->
<!-- 		<div id="modal-header"> -->
<!-- 			<h1><span id="jobHead"></span></h1> -->
<!-- 		</div> -->
<!-- 		<div id="modal-content"> -->
<!-- 			<h1>일감등록일:<span id="jobRdate"></span></h1>  -->
<!-- 			<h1>담당자: <span id="jobmem"></span></h1> -->
<!-- 			<h1>시작일: <span id="jobBdate"></span></h1> -->
<!-- 			<h1>종료일: <span id="jobEdate"></span></h1> -->
<!-- 			<h1>진행도: <span id="jobProgrses"></span>%</h1> -->
			
<!-- 		</div> -->
<!-- 		<div id="modal-footer"> -->
<!-- 			<h1>일감내용</h1> -->
<!-- 			<h1> <span id="jobCns"></span></h1> -->
<!-- 		</div>  -->
<!-- 	</div>  -->
<!-- </div> -->
				...
				for (var i = 0; i < jobSj.length; i++) {
				    ...
				    dateObjects.push({
				        ...
				        values: [{
				            ...
				            customClass: (jobStcd[i] === "1") ? "ganttGreen" :
				                (jobStcd[i] === "2") ? "ganttViolet" :
				                (jobStcd[i] === "3") ? "ganttRed" :
				                (jobStcd[i] === "4") ? "ganttFinsh" :
				                (jobStcd[i] === "5") ? "ganttStop" : ""
				        }]
				    });
				}
