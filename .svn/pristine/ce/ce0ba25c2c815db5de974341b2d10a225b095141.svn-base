...
<div class="container">
	<div class="dropzone" data-pro-sttus="1" data-add-bg="bg-primary">
		<div class="kanban-header col-md-6 card bg-success text-white mb-3"> <div style="width: 200px; height: 50px; background-color: rgb(106,108,246); border-radius: 5px; display: flex; align-items: center; justify-content: center;">
            진행
        </div></div>
					...
					<div id="project1_${vs.count}" class="draggable  col-md-6   card bg-primary text-white mb-3"
						...
						<div class="card-body">
							<h3 class="card-title text-white">
    								<a href="<c:url value='/job/${proj.proSn}/home'/>" style="color: white;" draggable="false">${proj.proNm}</a>
							</h3>
	...
	<div class="dropzone  borderline" data-pro-sttus="2" data-add-bg="bg-warning">
		<div class="kanban-header col-md-6 card bg-success text-white mb-3">
        <div style="width: 200px; height: 50px; background-color: orange; border-radius: 5px; display: flex; align-items: center; justify-content: center;">
            보류
        </div>
    </div>
	...
	<div class="dropzone  borderline" data-pro-sttus="3" data-add-bg="bg-success">
		<div class="kanban-header col-md-6 card bg-success text-white mb-3"> <div style="width: 200px; height: 50px; background-color: rgb(116,216,58); border-radius: 5px; display: flex; align-items: center; justify-content: center;">
            보류
        </div></div> 
